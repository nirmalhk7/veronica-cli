...
class VoiceUtility():
    ...
    def _espeak(self, msg):
        try:
            ...
            filename = "{}-veronica.temp.mp3".format(
    ...
    def speak(self, response, responsetts=None, interval=0):
        ...
        # Special thanks to @Darkonaut
        # https://stackoverflow.com/questions/52786288/python-running-code-simultaneously-tts-and-print-functions

        Timer(
            interval=interval,
            function=self._espeak,
            args=(
                response,
            )).start()
